        ...
        <div class="container-body" id="container-body">
            ...
            <div class="form-container">
                ...
                <div class="card-body form-content">
                    <form method="POST" action="{{ route('admin.store.soal') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="pertanyaan" name="pertanyaan" class="form-control @error('pertanyaan') is-invalid @enderror" placeholder="Isi Soal ujian .." required></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input id="jawaban_benar" type="text" name="jawaban_benar" class="form-control @error('jawaban_benar') is-invalid @enderror" placeholder="jika Esai tolong diisi '-'" required>
