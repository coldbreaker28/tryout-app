        ...
        <div class="container-body" id="container-body">
            ...
            <div class="table-container">
                ...
                <div class="group-filter">
                    <h5>Filter dengan : </h5>
                    <input type="search" placeholder="cari data peserta berdasarkan nama peserta" class="filter-cari" data-table="daftar-table">
                ...
                <table class="responsive-table daftar-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="border: 1px dashed #1B262C;" >{{ $item->skor }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
