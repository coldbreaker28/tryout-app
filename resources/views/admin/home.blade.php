        ...
        <div class="container-body" id="container-body">
            <div class="head-text">
                <article>
                    ...
                    <p>
                        " The man who does more than he is paid for will soon be paid more than he does "<br>
                        - Napoleon Hill
                    </p>
                </article>
            ...
            <div class="card-container" id="card-container">
                <div class="card-Indonesian">
                    <h3 style="text-align: center;">Bahasa Indonesia</h3>
                    <p>Jumlah Soal Ujian : {{$soalPerMapel['Bahasa Indonesia'] ?? 0 }}</p>
                    <hr>
                    <p>Soal Pilihan Ganda : {{ $jenisSoalPerMapel['Bahasa Indonesia']['pilihan ganda'] ?? 0 }}</p>
                    <p>Soal Esai : {{ $jenisSoalPerMapel['Bahasa Indonesia']['esai'] ?? 0 }}</p>
                </div>
                <div class="card-Matematika">
                    <h3 style="text-align: center;">Matematika</h3>
                    <p>Jumlah Soal Ujian : {{$soalPerMapel['Matematika'] ?? 0}} </p>
                    <hr>
                    <p>Soal Pilihan Ganda : {{ $jenisSoalPerMapel['Matematika']['pilihan ganda'] ?? 0 }}</p>
                    <p>Soal Esai : {{ $jenisSoalPerMapel['Matematika']['esai'] ?? 0 }}</p>
                </div>
                <div class="card-English">
                    <h3 style="text-align: center;">Bahasa Inggris</h3>
                    <p>Jumlah Soal Ujian : {{$soalPerMapel['Bahasa Inggris' ?? 0]}} </p>
                    <hr>
                    <p>Soal Pilihan Ganda : {{ $jenisSoalPerMapel['Bahasa Inggris']['pilihan ganda'] ?? 0 }}</p>
                    <p>Soal Esai : {{ $jenisSoalPerMapel['Bahasa Inggris']['esai'] ?? 0 }}</p>
                </div>
            </div>
